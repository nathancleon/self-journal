...
export const RelationshipsIcon = ({ fill }) => (
...
export const SelfReflectionIcon = ({ fill }) => (
  <svg
...
export const TriggerListIcon = ({ fill }) => (
